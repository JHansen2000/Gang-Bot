...
def get_commands(tree: discord.app_commands.CommandTree[discord.Client],
  ...
  async def waiver(interaction: discord.Interaction) -> None:
    try:
      ...
      embed.add_field(name="**3. Privacy and Data Collection**", value="Members acknowledge that CORE RP may collect and store personal information, including but not limited to IP addresses, game license numbers, and Discord identifiers, for the purpose of community management, security, and compliance with applicable laws and regulations. Members' personal information will be strictly protected and never released to third parties without consent, except as required by law", inline=False)
