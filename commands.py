...
def get_commands(tree: discord.app_commands.CommandTree[discord.Client],
  ...
  async def waiver(interaction: discord.Interaction) -> None:
    try:
      ...
      embed = discord.Embed(title="CORE RP Liability Waiver", description='This Liability Waiver ("Waiver") is entered into by and between CORE Roleplay ("CORE RP"), a legal Limited Liability Company registered in the State of Virginia, and all members ("Members") of the CORE RP community. For the purposes of this Waiver, "Applicants" refer to non-members seeking to join the community.', color=discord.Colour.brand_green())
      ...
      embed.add_field(name="**2. Representation of Age**", value='Members affirm they are 18 years of age or older, and understand that CORE RP is an adult-only community. Applicants under the age of 18 are not eligible to join the CORE RP community.')
      embed.add_field(name="**3. Release of Liability**", value='Members hereby release, waive, discharge, and covenant not to sue CORE RP, its owners, employees, agents, representatives, or affiliates from any and all claims, demands, losses, damages, liabilities, or expenses (including legal fees) arising out of or related to their participation in CORE RP activities, events, or interactions.', inline=False)
      embed.add_field(name="**4. Privacy and Data Collection**", value="Members acknowledge that CORE RP may collect and store personal information, including but not limited to IP addresses, game license numbers, and Discord identifiers, for the purpose of community management, security, and compliance with applicable laws and regulations. Members' personal information will be strictly protected and never released to third parties without consent, except as required by law", inline=False)
      embed.add_field(name="**5. Membership Termination**", value="CORE RP reserves the right to terminate any Member's membership with or without reason, at its sole discretion. Termination may occur immediately upon notice to the Member, and no refunds or compensation will be provided for any donations or in-game purchases made by the Member.", inline=False)
      embed.add_field(name="**6. Media Usage**", value="Members agree that any video or audio recordings captured within the CORE RP server shall not be used for commercial or personal gain without explicit authorization. Approved streamers and content creators may be entitled to exceptions under a separate media usage agreement.", inline=False)
      embed.add_field(name="**7. Asset Usage**", value="Members acknowledge that any CORE RP assets, including but not limited to custom scripts, textures, intellectual property, community videos, logos, images, titles, and other proprietary content, are strictly prohibited for use outside the CORE RP server without explicit authorization.", inline=False)
      embed.add_field(name="**8. Compliance with Laws**", value="Members agree to abide by all applicable Federal and State laws, regulations, and ordinances while participating in CORE RP activities. Members also agree not to engage in any illegal activities, including but not limited to hacking, cheating, or harassment, within the CORE RP community.", inline=False)
      embed.add_field(name="**9. Governing Law**", value="This Waiver shall be governed by and construed in accordance with the laws of the State of Virginia, without regard to its conflict of law provisions.", inline=False)
      embed.add_field(name="**10. Severability**", value="If any provision of this Waiver is found to be unenforceable or invalid, the remaining provisions shall remain in full force and effect.", inline=False)
      embed.add_field(name="**11. Acknowledgement**", value='By clicking "**I AGREE**", Members acknowledge that they have read and understood the terms of this Waiver and voluntarily agree to be bound by them.', inline=False)
